...
namespace MovieReviewWebAPI.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        [ProducesResponseType(200, Type = typeof(Review))]
        [ProducesResponseType(400)]
        public IActionResult GetReviewOfAMovie(int movidId)
        {
            var reviews = _mapper.Map<List<ReviewDto>>(_reviewRepository.GetReviewOfAMovie(movidId));
        ...
        public IActionResult DeleteReviewsByReviewer(int reviewerId)
        {
            ...
            var reviewsToDelete = _reviewerRepository.GetReviewByReviewerId(reviewerId).ToList();
            if (!ModelState.IsValid)
                return BadRequest();
