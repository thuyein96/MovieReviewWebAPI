...
namespace MovieReviewWebAPI.Controllers
{
    ...
    public class CountryController : Controller
    {
        ...
        [ProducesResponseType(200, Type = typeof(Country))]
        [ProducesResponseType(400)]
        public IActionResult GetCountryOfAProduction(int productionId)
        {
            var country = _mapper.Map<List<CountryDto>>(_countryRepository.GetCountryOfAProduction(productionId));
